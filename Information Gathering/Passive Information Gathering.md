...
- `WHOIS` is a query/response protocol defined in [RFC 3912](https://www.ietf.org/rfc/rfc3912.txt). WHOIS servers listen on **TCP port 43** and provide registration details for domain names.
...
- Sites:[whois.com](http://whois.com/), [whois.icann.org](http://whois.icann.org/).
...
- **Useful frameworks**:
    - [OSINT Framework](https://osintframework.com/) — Interactive map of tools
...
- **Sites**:
    - [sitereport.netcraft.com](https://sitereport.netcraft.com/) — Site report (server, OS, history)
    - [searchdns.netcraft.com](https://searchdns.netcraft.com/) — DNS search & related sites
- **What it reveals:**
...
- Shodan ([shodan.io](http://shodan.io/)) is a search engine that continuously scans the entire internet and indexes the results(Search engine for internet-connected devices).
- **Core searches:**
    - `hostname:target.com`
    - `org:"Target Organization Name"`
    - `ssl:"[target.com](http://target.com/)"`
- **What it reveals:**
...
- **Tools**:
    - [ssllabs.com/ssltest](https://www.ssllabs.com/ssltest) (Qualys) — Industry standard, gives A–F grade
    - Hardenize
